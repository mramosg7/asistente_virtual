...
__all__ = [
    'STCInprocServer', 'SVSFNLPMask', 'SP_VISEME_10',
    'DISPID_SABIBufferSize', 'ISpeechPhraseElement',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SWFEAvgBytesPerSec',
    'SDTRule', 'DISPID_SPRsCount', 'SSFMCreate',
    'SpeechCategoryRecoProfiles', 'DISPID_SpeechPhraseProperties',
    'SVP_10', 'SPLEXICONTYPE', 'DISPID_SPPName', 'SPSNotOverriden',
    'DISPID_SRAudioInput', 'DISPID_SpeechRecoContext',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SGRSTsCount',
    'DISPID_SPPsCount', 'DISPID_SGRSTText', 'eLEXTYPE_RESERVED9',
    'SpeechDictationTopicSpelling', 'SVSFParseMask',
    'DISPID_SPAPhraseInfo', 'SPEI_INTERFERENCE',
    'DISPID_SRCEAdaptation', 'SpeechAudioVolume', 'SRATopLevel',
    'SpeechPropertyLowConfidenceThreshold', 'eLEXTYPE_RESERVED8',
    'DISPID_SLGenerationId', 'SRAONone', 'SPWORD', 'SPEI_SR_BOOKMARK',
    'ISpObjectToken', 'SPCS_DISABLED', 'eLEXTYPE_PRIVATE15',
    'SVEEndInputStream', 'DISPID_SGRName', 'ISpResourceManager',
    'SAFTDefault', 'SpeechTokenValueCLSID',
    'SWPKnownWordPronounceable', 'eWORDTYPE_ADDED',
    'DISPID_SOTCategory', 'SpeechUserTraining',
    'SpeechAudioFormatGUIDText', 'SVP_7', 'ISpAudio',
    'DISPID_SPEAudioStreamOffset', 'SpMMAudioOut', 'SVSFParseSsml',
    'DISPID_SRGetFormat', 'DISPID_SpeechCustomStream',
    'SAFTNonStandardFormat', 'DISPID_SRRAlternates',
    'DISPID_SABufferNotifySize', 'DISPID_SpeechMemoryStream',
    'SPEVENTENUM', 'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SPIRule',
    'SRSInactiveWithPurge', 'SP_VISEME_13', 'DISPID_SpeechDataKey',
    'DISPID_SRCreateRecoContext', 'SRCS_Enabled', 'SITooLoud',
    'SpLexicon', 'SECFDefault', 'DISPID_SRCEHypothesis',
    'DISPID_SVSCurrentStreamNumber', 'ISpeechAudio',
    'ISpStreamFormat', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SLPsItem', 'DISPID_SLGetWords',
    'DISPID_SOTRemoveStorageFileName', 'eLEXTYPE_RESERVED10',
    'DISPID_SOTCreateInstance', 'STCInprocHandler', 'SVP_0',
    'ISpeechLexiconWords', 'ISpeechLexiconWord', 'SVF_Emphasis',
    'SPEVENTSOURCEINFO', 'DISPID_SVEVoiceChange', 'SVEViseme',
    'SPEI_RESERVED6', 'SPVPRI_OVER', 'SP_VISEME_14', 'SPVISEMES',
    'SAFTADPCM_8kHzStereo', 'DISPID_SGRs_NewEnum',
    'ISpeechRecoContext', 'SPADAPTATIONRELEVANCE',
    'SDKLCurrentConfig', 'SPSEMANTICERRORINFO', 'DISPID_SPRText',
    'SPAR_High', 'SpMMAudioEnum', 'SPVPRI_NORMAL', 'SITooSlow',
    'SVP_17', 'SAFT48kHz16BitMono', 'eWORDTYPE_DELETED',
    'SDA_Consume_Leading_Spaces', 'SPPS_SuppressWord',
    'DISPID_SPIEngineId', 'SVP_11', 'ISpPhraseAlt', 'SVP_15',
    'DISPID_SpeechPhoneConverter', 'ISpStream',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpLexicon',
    'DISPID_SDKGetlongValue', 'SGRSTTEpsilon',
    'DISPID_SOTCGetDataKey', 'SAFT8kHz8BitMono', 'SP_VISEME_5',
    'ISpeechRecoResult', 'ISpPhrase', 'DISPID_SLPLangId', 'SLOStatic',
    'SVSFParseSapi', 'DISPID_SGRsAdd', 'SPPS_Noncontent',
    'SPSFunction', 'DISPID_SVGetAudioInputs', 'DISPID_SOTDisplayUI',
    'SSFMCreateForWrite', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechAudioState', 'DISPIDSPRG', 'DISPID_SASCurrentSeekPosition',
    'SFTInput', 'DISPID_SPEsCount', 'SpeechPropertyResourceUsage',
    'SPEI_PHONEME', 'SPWORDPRONUNCIATIONLIST', 'DISPID_SLPPhoneIds',
    'DISPID_SRRTLength', 'DISPID_SABIEventBias',
    'DISPID_SPRuleEngineConfidence', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFT12kHz8BitStereo', 'SPGS_DISABLED', 'SpUnCompressedLexicon',
    'SRARoot', 'DISPID_SRGState', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SABIMinNotification',
    'SVSFIsFilename', 'DISPID_SLGetGenerationChange',
    'DISPIDSPTSI_SelectionOffset', 'SpeechTokenKeyUI',
    'ISpeechPhraseReplacement', 'DISPID_SRRTTickCount',
    'DISPID_SVEWord', 'eLEXTYPE_PRIVATE16', 'DISPID_SABufferInfo',
    'SGDSActive', 'SAFT11kHz8BitMono', 'SGRSTTDictation', 'SPSMF_UPS',
    'SPRST_NUM_STATES', 'SpAudioFormat', 'DISPID_SRGetRecognizers',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SRSSupportedLanguages', 'SpeechGrammarState',
    'eLEXTYPE_PRIVATE20', 'ISpeechPhraseInfo', 'SVEAllEvents',
    'DISPID_SPRuleId', 'SVP_1', 'SpCustomStream', 'SPAO_NONE',
    'ISpRecoContext', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPEI_START_INPUT_STREAM', 'SAFT11kHz16BitMono', 'SP_VISEME_3',
    'DISPID_SPRNumberOfElements', '_RemotableHandle',
    'DISPID_SGRsItem', 'SpeechVisemeType', 'SVPAlert',
    'SAFT48kHz16BitStereo', 'DISPID_SMSGetData', 'SLODynamic',
    'ISpeechRecoResult2', 'ISpeechObjectTokens',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SLAddPronunciation', 'STCAll', 'SAFT16kHz16BitStereo',
    'SpeechPropertyAdaptationOn', 'DISPID_SRCResume',
    'SPSHT_NotOverriden', 'ISpNotifySource', 'DISPID_SVRate',
    'SVP_18', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPEEngineConfidence',
    'DISPID_SRRecognizer', 'SVF_None', 'ISpeechPhraseReplacements',
    'ISpeechBaseStream', 'SAFT48kHz8BitMono', 'DISPID_SRGRecoContext',
    'SPFM_CREATE_ALWAYS', 'DISPID_SDKCreateKey',
    'SpeechEngineConfidence', 'ISpRecognizer3', 'SAFT24kHz8BitStereo',
    'SVP_13', 'SP_VISEME_15', 'SVSFlagsAsync', 'SPLO_DYNAMIC',
    'DISPID_SBSWrite', 'DISPID_SpeechVoiceEvent', 'SpStream',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPIDSPTSI_ActiveOffset', 'SpResourceManager',
    'DISPID_SVAudioOutputStream', 'SPCS_ENABLED', 'SPPS_RESERVED4',
    'SPEI_RECOGNITION', 'SAFT11kHz8BitStereo', 'SAFT48kHz8BitStereo',
    'SPEI_REQUEST_UI', 'DISPID_SASetState', 'ISpeechLexicon',
    'SASPause', 'SP_VISEME_7', 'SAFT24kHz8BitMono',
    'ISpeechLexiconPronunciations', 'DISPID_SPRsItem',
    'DISPID_SLWType', 'SPBO_AHEAD', 'DISPID_SRCSetAdaptationData',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SpeechPhraseElements', 'SPSUnknown',
    'SpeechAddRemoveWord', 'SREInterference', 'SVEWordBoundary',
    'ISpeechAudioBufferInfo', 'SFTSREngine', 'DISPID_SVEViseme',
    'SpeechVisemeFeature', 'DISPID_SLWLangId', 'SPLOADOPTIONS',
    'SRTEmulated', 'DISPID_SPEActualConfidence', 'SPPS_LMA',
    'DISPID_SRRRecoContext', 'SPRST_ACTIVE', 'ISpeechVoiceStatus',
    'SpeechVoicePriority', 'DISPID_SDKDeleteKey', 'SPRST_INACTIVE',
    'DISPID_SOTRemove', 'DISPID_SOTId', 'DISPID_SOTGetDescription',
    'SSSPTRelativeToStart', 'STSF_AppData', 'DISPIDSPTSI',
    'SRAImport', 'SAFT8kHz16BitStereo', 'DISPID_SVIsUISupported',
    'DISPID_SRCEEndStream', '_ISpeechVoiceEvents', 'SVSFDefault',
    'DISPID_SLWPronunciations', 'SVP_12',
    'DISPID_SRGetPropertyString', 'SECFIgnoreCase',
    'DISPID_SREmulateRecognition', 'SpeechTokenContext',
    'SpeechLoadOption', 'eLEXTYPE_USER', 'LONG_PTR', 'SVP_3',
    'DISPID_SDKEnumValues', 'DISPID_SPISaveToMemory', 'SREPrivate',
    'DISPID_SLPType', 'SPPS_Function', 'SVESentenceBoundary',
    'Speech_Default_Weight', 'DISPID_SPIProperties', 'SASClosed',
    'SpeechRecognizerState', 'DISPID_SVEAudioLevel', 'UINT_PTR',
    'SRTSMLTimeout', 'SGPronounciation', 'SpeechBookmarkOptions',
    'DISPID_SGRInitialState', 'DISPID_SVResume',
    'SAFTADPCM_44kHzStereo', 'SPFM_CREATE', 'DISPID_SPILanguageId',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SVStatus', 'DISPID_SPPValue',
    'ISpeechMemoryStream', 'DISPID_SpeechFileStream', 'SDTAudio',
    'SPVOICESTATUS', 'DISPID_SPEsItem', 'ISpeechRecognizerStatus',
    'DISPID_SpeechObjectToken', 'SP_VISEME_6', 'DISPID_SGRSTsItem',
    'DISPID_SRSClsidEngine', 'DISPID_SRCERecognizerStateChange',
    'SpeechPropertyResponseSpeed', 'Speech_StreamPos_RealTime',
    'SITooFast', 'DISPID_SRCEventInterests', 'SVP_2',
    'DISPID_SVGetAudioOutputs', 'DISPID_SVPause', 'SVSFNLPSpeakPunc',
    'SSSPTRelativeToCurrentPosition', 'SPEI_RESERVED3',
    'ISpeechRecognizer', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SECLowConfidence', 'SPSLMA', 'DISPID_SASFreeBufferSpace',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SpeechPhraseInfo',
    'DISPID_SRState', 'DISPID_SRCEEnginePrivate',
    'SAFTADPCM_22kHzStereo', 'DISPID_SLPsCount',
    'ISpeechGrammarRuleState', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SpeechPhraseAlternates', 'SP_VISEME_11',
    'DISPID_SPCPhoneToId', 'DISPID_SPAStartElementInResult',
    'SPBO_NONE', 'SPEI_TTS_BOOKMARK', 'SAFTGSM610_44kHzMono',
    'DISPID_SRCERecognition', 'ISpPhoneConverter',
    'ISpObjectWithToken', 'SpeechInterference',
    'SPXRO_Alternates_SML', 'eLEXTYPE_RESERVED7',
    'IInternetSecurityManager', 'SGRSTTWord', 'SDTDisplayText',
    'SPSModifier', 'ISpShortcut', 'SpPhoneticAlphabetConverter',
    'SSTTTextBuffer', 'DISPID_SpeechPhraseProperty',
    'SpeechTokenShellFolder', 'SPWF_SRENGINE',
    'DISPID_SPIAudioSizeBytes', 'SPFM_OPEN_READWRITE', 'SpMMAudioIn',
    'ISpNotifySink', 'DISPID_SAStatus',
    'SpeechGrammarTagUnlimitedDictation', 'ISpeechPhraseRule',
    'DISPID_SOTs_NewEnum', 'SDTPronunciation', 'DISPID_SRGCommit',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPCT_SLEEP',
    'DISPID_SpeechRecognizer', 'DISPID_SOTCDefault',
    'SpeechFormatType', 'SPPHRASEPROPERTY', 'DISPID_SRCEPhraseStart',
    'SpMemoryStream', 'DISPID_SRGCmdSetRuleIdState', 'SINone',
    'SLTApp', 'SAFTGSM610_8kHzMono', 'SPAS_STOP',
    'DISPID_SPIAudioSizeTime', 'DISPID_SDKSetBinaryValue',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpEventSource',
    'SPCT_SUB_DICTATION', 'DISPID_SADefaultFormat', 'SVPNormal',
    'DISPID_SLWsCount', 'SGRSTTRule', 'ISpeechPhraseInfoBuilder',
    'DISPID_SVEStreamStart', 'SBONone', 'SPAUDIOOPTIONS',
    'eLEXTYPE_PRIVATE11', 'DISPID_SAEventHandle', 'SVF_Stressed',
    'DISPID_SWFEFormatTag', 'DISPID_SPIGetDisplayAttributes',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPRS_ACTIVE', 'SRTAutopause',
    'SPEI_SOUND_END', 'SpStreamFormatConverter', 'SPGRAMMARSTATE',
    'SDA_One_Trailing_Space', 'ISpeechRecoGrammar',
    'SREPropertyStringChange', 'SPWT_DISPLAY',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SPRuleParent',
    'ISpeechResourceLoader', 'DISPID_SOTCId',
    'DISPID_SRSetPropertyNumber', 'SPWT_LEXICAL',
    'SPSHORTCUTPAIRLIST', 'ISpRecoResult', 'SpeechDiscardType',
    'eLEXTYPE_PRIVATE18', 'SBOPause', 'SITooQuiet', 'SDTReplacement',
    'SDA_No_Trailing_Space', 'SVP_16', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SpeechPhraseAlternate',
    'SREBookmark', 'ISpeechDataKey', 'DISPID_SPRuleConfidence',
    'SpVoice', 'SAFTADPCM_22kHzMono', 'SAFTGSM610_22kHzMono',
    'DISPID_SpeechVoice', 'SpCompressedLexicon', 'SRSActive',
    'DISPID_SRCEBookmark', 'DISPID_SGRSTransitions', 'SPVPRI_ALERT',
    'IStream', 'DISPID_SVSInputSentenceLength',
    'ISpeechRecoResultDispatch', 'DISPID_SOTsItem', 'DISPID_SRGRules',
    'ISpGrammarBuilder', 'SPAUDIOBUFFERINFO', 'SPEI_MAX_TTS',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SBSRead',
    'SPWORDPRONUNCIATION', 'SVEVoiceChange',
    'DISPID_SpeechGrammarRule',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SpeechRegistryUserRoot', 'eLEXTYPE_PRIVATE10',
    'DISPID_SpeechBaseStream', 'SPPHRASERULE', 'DISPID_SBSFormat',
    'DISPID_SRRTimes', 'eLEXTYPE_PRIVATE17', 'SGRSTTWildcard',
    'SP_VISEME_1', 'SVP_8', 'STSF_LocalAppData',
    'DISPID_SPRulesCount', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SpeechObjectTokens', 'DISPID_SPIEnginePrivateData',
    'SpPhraseInfoBuilder', 'SpeechPartOfSpeech', 'SVP_6',
    'SpeechRetainedAudioOptions', 'DISPID_SVPriority',
    'SpInprocRecognizer', 'DISPID_SpeechVoiceStatus', 'SVEAudioLevel',
    'SAFTADPCM_8kHzMono', 'ISpeechGrammarRule',
    'SpeechTokenIdUserLexicon', 'DISPID_SPPsItem',
    'Speech_Max_Pron_Length', 'DISPID_SVEEnginePrivate',
    'DISPID_SGRSTPropertyValue', 'DISPID_SMSALineId',
    'DISPID_SPARecoResult', 'SPSERIALIZEDRESULT', 'SRSEDone',
    'ISpeechPhraseAlternates', 'DISPID_SRStatus', 'SPEI_VISEME',
    'DISPID_SGRSAddWordTransition', 'SGLexical',
    'DISPID_SDKGetBinaryValue', 'SVP_19',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SASNonBlockingIO', 'SAFTADPCM_11kHzMono',
    'DISPID_SpeechRecognizerStatus',
    'DISPID_SpeechLexiconPronunciation', 'SVEPhoneme',
    'SSSPTRelativeToEnd', 'DISPID_SVEPhoneme', 'DISPID_SRCState',
    'SPRECORESULTTIMES', 'SAFT8kHz16BitMono', 'SVSFParseAutodetect',
    'SPDKL_DefaultLocation', 'SPAO_RETAIN_AUDIO', 'SAFTText',
    'eLEXTYPE_RESERVED6', 'eLEXTYPE_PRIVATE6', 'DISPID_SPRs_NewEnum',
    'DISPID_SOTIsUISupported', 'DISPID_SpeechRecoResult2',
    'IEnumSpObjectTokens', 'SPPS_RESERVED2', 'eLEXTYPE_PRIVATE4',
    'DISPID_SPIStartTime', 'DISPID_SAFGuid', 'DISPID_SPRuleChildren',
    'ISpRecoContext2', 'ISpObjectTokenCategory',
    'DISPID_SRSetPropertyString', 'SPPS_Verb', 'SRESoundEnd',
    'DISPID_SRCESoundEnd', 'SPSSuppressWord',
    'DISPID_SRGCmdLoadFromFile', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SGRsCommitAndSave', 'SPVPRIORITY', 'SpeechLexiconType',
    'SpeechRunState', 'SSTTDictation', 'DISPID_SPEDisplayAttributes',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SAFSetWaveFormatEx',
    'SPCT_DICTATION', 'DISPID_SpeechLexicon', 'DISPID_SRCVoice',
    'SPAS_PAUSE', 'DISPID_SPCIdToPhone', 'SSTTWildcard',
    'SPRECOCONTEXTSTATUS', 'ISpeechXMLRecoResult',
    'SGDSActiveUserDelimited', 'SPWORDLIST', 'SPEI_WORD_BOUNDARY',
    'DISPID_SpeechAudioStatus', 'SASRun', 'eLEXTYPE_PRIVATE2',
    'DISPID_SVVolume', 'DISPID_SpeechRecoResult', 'SREAllEvents',
    'eLEXTYPE_PRIVATE19', 'ISpeechPhraseProperties',
    'SPGRAMMARWORDTYPE', 'SP_VISEME_2', 'SAFTNoAssignedFormat',
    'SpeechRuleState', 'DISPID_SVSPhonemeId', 'ISpeechWaveFormatEx',
    'SpFileStream', 'DISPID_SPIElements', 'DISPID_SPRulesItem',
    'DISPID_SDKGetStringValue', 'eLEXTYPE_LETTERTOSOUND',
    'ISpNotifyTranslator', 'DISPID_SGRSTRule', 'DISPID_SRRPhraseInfo',
    'SDKLCurrentUser', 'SPBOOKMARKOPTIONS', 'SpeechCategoryAudioOut',
    'DISPID_SPPParent', 'SPDKL_LocalMachine', 'SAFTADPCM_11kHzStereo',
    'SPPS_RESERVED3', 'SPEI_SR_RETAINEDAUDIO', 'SAFT22kHz8BitMono',
    'SPPHRASEELEMENT', 'SP_VISEME_4', 'SPRECOSTATE',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SPAsCount', 'SVP_20',
    'ISpProperties', 'DISPID_SVVoice', 'SpeechVoiceSpeakFlags',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRGCmdLoadFromObject',
    'SRERecognition', 'SPXMLRESULTOPTIONS', 'DISPID_SRGReset',
    'DISPID_SRCEStartStream', 'SPRS_INACTIVE',
    'ISpeechTextSelectionInformation', 'ISpeechObjectTokenCategory',
    'SECFNoSpecialChars', 'STCLocalServer',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'eLEXTYPE_MORPHOLOGY',
    'SpObjectTokenCategory', 'SPSHT_EMAIL',
    'DISPID_SLGetPronunciations', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SREStreamEnd', 'SECFIgnoreKanaType', 'SAFT32kHz8BitStereo',
    'ISpXMLRecoResult', 'DISPID_SRIsUISupported',
    'DISPID_SVSLastBookmark', 'eLEXTYPE_PRIVATE9',
    'ISpPhoneticAlphabetConverter', 'SPPHRASE', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRCEFalseRecognition', 'SPEI_SENTENCE_BOUNDARY',
    'SPBINARYGRAMMAR', 'DISPID_SRIsShared',
    'SpeechCategoryRecognizers', 'SVP_14',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SAFT16kHz8BitMono',
    'SPEI_START_SR_STREAM', 'DISPID_SpeechPhraseRule',
    'SAFT11kHz16BitStereo', 'SRSActiveAlways',
    'SPEI_FALSE_RECOGNITION', 'SPPS_Unknown',
    'DISPID_SRRGetXMLResult', 'SAFT22kHz16BitStereo', 'SPSVerb',
    'SECFIgnoreWidth', 'SP_VISEME_8', 'SPINTERFERENCE_TOOLOUD',
    'SpeechVoiceEvents', 'SGSExclusive',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SRCRequestedUIType',
    'DISPID_SGRSTWeight', 'SPCT_SUB_COMMAND', 'SpeechRuleAttributes',
    'SVP_5', 'SAFTCCITT_ALaw_44kHzMono', 'SPGS_ENABLED', 'SPAS_RUN',
    'SDKLDefaultLocation', 'DISPID_SWFEBlockAlign',
    'DISPID_SPEPronunciation', 'DISPID_SPPFirstElement',
    'SpeechGrammarTagWildcard', 'DISPID_SpeechPhraseRules',
    'DISPID_SOTGetAttribute', 'DISPID_SDKDeleteValue',
    'DISPID_SMSAMMHandle', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SRProfile', 'SVSFUnusedFlags', 'SPWT_PRONUNCIATION',
    'SRTStandard', 'DISPID_SGRSTNextState', 'SPRST_ACTIVE_ALWAYS',
    'eLEXTYPE_PRIVATE3', 'DISPID_SpeechAudio', 'SpeechAllElements',
    'SAFT24kHz16BitMono', 'DISPID_SpeechLexiconProns',
    'SWPUnknownWordUnpronounceable', 'SAFT44kHz8BitMono',
    'SAFT22kHz16BitMono', 'SAFTCCITT_ALaw_22kHzMono', 'ISpeechVoice',
    'ISpeechRecoResultTimes', 'DISPID_SOTsCount', 'SVSFPersistXML',
    'SRCS_Disabled', 'SPDATAKEYLOCATION', 'SGSDisabled',
    'SVSFVoiceMask', 'SPSHORTCUTPAIR', 'SAFT44kHz16BitMono',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SGRAddState',
    'ISpeechLexiconPronunciation', 'DISPID_SVSyncronousSpeakTimeout',
    'ISpeechAudioStatus', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SMSSetData', 'SpeechRecoEvents', 'SpObjectToken',
    'ISpRecognizer2', 'SP_VISEME_18', 'DISPID_SVSLastBookmarkId',
    'DISPID_SVESentenceBoundary', 'SDTProperty', 'SREStateChange',
    'SPWF_INPUT', 'SpPhoneConverter', 'SPEI_END_SR_STREAM',
    'SPEI_TTS_PRIVATE', 'SPSNoun', 'SPEI_PHRASE_START',
    'SAFTCCITT_uLaw_11kHzMono', 'SRESoundStart',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPIGrammarId',
    'DISPID_SPRuleName', 'DISPID_SPPChildren', 'ISpSerializeState',
    'STCRemoteServer', 'DISPID_SRAudioInputStream',
    'SpeechPropertyComplexResponseSpeed', 'SREHypothesis',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SpeechWaveFormatEx',
    'SpeechTokenKeyAttributes', 'SGDisplay', 'DISPID_SVGetVoices',
    'SP_VISEME_16', 'SpTextSelectionInformation',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFT32kHz16BitStereo', 'DISPID_SFSClose', 'SPEI_VOICE_CHANGE',
    'SpeechDataKeyLocation', 'DISPID_SGRsCommit', 'SWTDeleted',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SVGetProfiles',
    'SSFMOpenReadWrite', 'SPSTREAMFORMATTYPE', 'DISPID_SAFType',
    'DISPID_SGRSRule', 'DISPID_SRRGetXMLErrorInfo',
    'SRADefaultToActive', 'SPPS_Interjection', 'SPAR_Medium',
    'SpWaveFormatEx', 'SRSInactive', 'DISPID_SPEAudioSizeTime',
    'SRERecoOtherContext', 'DISPID_SLRemovePronunciation',
    'SREPhraseStart', 'SpeechGrammarWordType',
    'eLEXTYPE_USER_SHORTCUT', 'ISpeechPhraseProperty',
    'SDA_Two_Trailing_Spaces', 'SPEI_MIN_TTS',
    'SAFTCCITT_uLaw_8kHzMono', 'SpeechAudioFormatType', 'ISpVoice',
    'IEnumString', 'DISPID_SGRSAddSpecialTransition',
    'SECFEmulateResult', 'SpNullPhoneConverter',
    'DISPID_SRCCreateGrammar', 'DISPID_SPIReplacements',
    'ISpeechGrammarRuleStateTransition', 'ISpeechFileStream',
    ...
    'tagSPTEXTSELECTIONINFO', 'DISPID_SPACommit',
    'DISPID_SRGSetTextSelection', 'SpeechRecoProfileProperties',
    'ISpEventSink', 'DISPID_SGRSTs_NewEnum', 'SVEPrivate',
    ...
    'DISPID_SVAudioOutput', 'DISPID_SLWsItem', 'SRTReSent',
    'DISPID_SPEAudioTimeOffset', 'SP_VISEME_9', 'SPDKL_CurrentConfig',
    'DISPID_SPRuleFirstElement', 'SPAR_Unknown', 'ISpRecoGrammar',
    'SpeechRecognitionType', 'SPPS_RESERVED1', 'SPBO_TIME_UNITS',
    'DISPID_SRCAudioInInterferenceStatus', 'WAVEFORMATEX',
    'SPFM_NUM_MODES', 'DISPID_SLWs_NewEnum', 'SPSInterjection',
    'SINoSignal', 'SpeechStreamSeekPositionType',
    'SpeechSpecialTransitionType', 'SpeechGrammarTagDictation',
    'DISPID_SDKEnumKeys', 'IInternetSecurityMgrSite',
    'DISPIDSPTSI_ActiveLength', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SPPId',
    'SpeechStreamFileMode', 'DISPID_SpeechAudioFormat',
    'DISPID_SPAsItem', 'SRAORetainAudio', 'DISPID_SCSBaseStream',
    'DISPID_SRCEPropertyNumberChange', 'SPAR_Low', 'SGDSInactive',
    'SP_VISEME_20', 'DISPID_SRSNumberOfActiveRules',
    'SAFT32kHz16BitMono', 'DISPID_SRRAudio', 'SpNotifyTranslator',
    'DISPID_SpeechPhraseBuilder', 'SpeechEmulationCompareFlags',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SpeechPhraseReplacement',
    'ISpeechPhoneConverter', 'SPFILEMODE', 'eLEXTYPE_PRIVATE1',
    'DISPID_SRRTOffsetFromStart', 'SpeechEngineProperties', 'SPEVENT',
    'SpeechMicTraining', 'SPEI_MAX_SR', 'DISPID_SVDisplayUI',
    'SDTAll', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SGRAttributes',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SVEStreamEnd',
    'SPEI_SOUND_START', '_ISpeechRecoContextEvents',
    'SPDKL_CurrentUser', 'SPRULESTATE', '__MIDL_IWinTypes_0009',
    'SDTLexicalForm', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpeechCategoryAudioIn', 'DISPID_SpeechMMSysAudio',
    'DISPID_SVEBookmark', 'DISPID_SGRsFindRule', 'SDTAlternates',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRGCmdLoadFromMemory',
    'SRAExport', 'DISPID_SLPPartOfSpeech', 'ISpRecognizer',
    'SPPS_Noun', 'DISPID_SPCLangId', 'DISPID_SpeechGrammarRuleState',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SGRId',
    'DISPID_SWFEChannels', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpeechGrammarRules',
    'DISPID_SLPSymbolic', 'ISpeechMMSysAudio',
    'DISPID_SRCEInterference', 'DISPID_SRRSaveToMemory',
    'SPSMF_SAPI_PROPERTIES', 'SINoise', 'SpSharedRecognizer',
    'SVSFPurgeBeforeSpeak', 'DISPID_SRGDictationLoad',
    'SWPUnknownWordPronounceable', 'eLEXTYPE_PRIVATE8',
    'DISPID_SGRSTPropertyId', 'SP_VISEME_17',
    'SpeechVoiceCategoryTTSRate', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPEI_SR_PRIVATE', 'SpeechRecoContextState', 'SPCT_COMMAND',
    'DISPID_SOTMatchesAttributes', 'SPSHORTCUTTYPE',
    'DISPID_SDKOpenKey', 'SPEI_RECO_STATE_CHANGE', 'SPEI_ADAPTATION',
    'DISPID_SRCERequestUI', 'SpeechDisplayAttributes',
    'DISPID_SRCBookmark', 'SECNormalConfidence', 'DISPID_SOTCSetId',
    'DISPID_SLWWord', 'DISPID_SOTCEnumerateTokens', 'SPXRO_SML',
    'SPSHT_OTHER', 'SREFalseRecognition', 'SPRULE', 'SVP_21',
    'SPFM_OPEN_READONLY', 'SPPS_NotOverriden',
    'DISPID_SDKSetStringValue', 'DISPID_SVSpeakStream',
    'DISPID_SRGIsPronounceable', 'SVPOver', 'DISPID_SPEs_NewEnum',
    'DISPID_SOTSetId', 'SPEI_RESERVED1', 'SLTUser', 'SPBO_PAUSE',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SRGDictationUnload',
    'DISPID_SRCESoundStart', 'SRSEIsSpeaking',
    'DISPID_SPIAudioStreamPosition', 'SPEI_UNDEFINED',
    'DISPID_SLPs_NewEnum', 'SpeechCategoryAppLexicons',
    'SPEI_RESERVED2', 'SREAdaptation', 'SDKLLocalMachine',
    'SPAUDIOSTATUS', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SVSVisemeId', 'DISPID_SPELexicalForm', 'SPAS_CLOSED',
    'DISPID_SRSAudioStatus', 'SAFTExtendedAudioFormat',
    'DISPID_SPPEngineConfidence',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SpSharedRecoContext',
    'DISPID_SASState', 'SPPS_Modifier', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRSCurrentStreamNumber', 'SAFT44kHz8BitStereo',
    'SRERequestUI', 'SPAUDIOSTATE', 'SREAudioLevel',
    'STSF_CommonAppData', 'eLEXTYPE_PRIVATE14',
    'Speech_StreamPos_Asap', 'SVP_4', 'ISpeechCustomStream',
    'DISPID_SVAlertBoundary', 'SAFT16kHz16BitMono',
    'DISPID_SGRsCount', 'Speech_Max_Word_Length',
    'DISPID_SVSRunningState', 'DISPID_SRRTStreamTime',
    'tagSPPROPERTYINFO', 'ISpeechPhraseElements',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechPropertyHighConfidenceThreshold', 'SP_VISEME_12',
    'ISequentialStream', 'DISPID_SpeechGrammarRules', 'SWTAdded',
    'SPINTERFERENCE_NOISE', 'SpeechRegistryLocalMachineRoot',
    'SVSFIsNotXML', 'SPWORDTYPE', 'SAFT44kHz16BitStereo',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPEDisplayText',
    'SAFTGSM610_11kHzMono', 'SPPHRASEREPLACEMENT',
    'DISPID_SPAs_NewEnum', 'SP_VISEME_21',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SpeechLexiconWord',
    'DISPID_SRCPause', 'ISpStreamFormatConverter', 'SPWAVEFORMATTYPE',
    'DISPID_SRCRetainedAudio', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPEI_HYPOTHESIS', 'DISPID_SPIRetainedSizeBytes',
    'SPSEMANTICFORMAT', 'DISPID_SGRSTType',
    'DISPID_SVSInputWordLength', 'DISPID_SMSADeviceId',
    'SAFT12kHz8BitMono', 'SAFTCCITT_ALaw_11kHzStereo',
    'SAFT16kHz8BitStereo', 'SPSERIALIZEDPHRASE',
    'DISPID_SRRSetTextFeedback', 'DISPID_SAVolume',
    'SRTExtendableParse', 'ISpeechPhraseAlternate', 'SPSHT_Unknown',
    'DISPID_SRDisplayUI', 'SPEI_MIN_SR', 'DISPID_SPRFirstElement',
    'SRADynamic', 'eLEXTYPE_RESERVED4', 'DISPID_SWFEBitsPerSample',
    'tagSTATSTG', 'SVSFIsXML', 'SVEStartInputStream',
    'DISPID_SRRAudioFormat', 'SGRSTTTextBuffer',
    'DISPID_SRGDictationSetState', 'DISPID_SPERequiredConfidence',
    'DISPID_SBSSeek', 'SpeechAudioFormatGUIDWave',
    'SPINTERFERENCE_NONE', 'SREPropertyNumChange', 'SPINTERFERENCE',
    'DISPID_SPPConfidence', 'SpeechAudioProperties',
    'DISPID_SOTDataKey', 'SSFMOpenForRead', 'SASStop',
    'SPCONTEXTSTATE', 'eLEXTYPE_PRIVATE12', 'SRAInterpreter',
    'DISPID_SpeechLexiconWords', 'ISpeechAudioFormat', 'SVEBookmark',
    'eLEXTYPE_PRIVATE7', 'DISPID_SRRSpeakAudio', 'SP_VISEME_19',
    'ISpMMSysAudio', 'SpInProcRecoContext', 'SAFT8kHz8BitStereo',
    'DISPID_SPRDisplayAttributes', 'DISPID_SpeechRecoResultTimes',
    'SPCATEGORYTYPE', 'SAFT24kHz16BitStereo',
    'DISPID_SRGetPropertyNumber', 'DISPID_SPPs_NewEnum',
    'DISPID_SRGCmdLoadFromResource', 'SVP_9', 'SPEI_END_INPUT_STREAM',
    'DISPID_SGRAddResource', 'SECHighConfidence',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SVEventInterests',
    'SpeechWordType', 'eLEXTYPE_APP', 'DISPID_SWFEExtraData',
    'DISPID_SGRClear', 'SAFT32kHz8BitMono',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpPhoneticAlphabetSelection',
    'ISpDataKey', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SFSOpen',
    'SpeechWordPronounceable', 'DISPID_SGRsDynamic',
    'SGDSActiveWithAutoPause', 'SPLO_STATIC', 'SPPARTOFSPEECH',
    'SPWORDPRONOUNCEABLE', 'DISPID_SRCRecognizer',
    'SPEI_TTS_AUDIO_LEVEL', 'SAFTCCITT_ALaw_8kHzMono',
    'SAFTADPCM_44kHzMono', 'SGLexicalNoSpecialChars',
    'SpeechTokenKeyFiles', 'ISpRecoCategory',
    'DISPID_SRGCmdSetRuleState', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SRGId', 'SP_VISEME_0', 'SPPROPERTYINFO',
    'ISpRecoGrammar2', 'ISpeechPhraseRules', 'DISPID_SDKSetLongValue',
    'DISPID_SVSpeak', 'SpeechCategoryVoices', 'SGSEnabled',
    'DISPID_SVSkip', '_SPAUDIOSTATE', 'SpShortcut', 'SPEI_RESERVED5',
    'SPGS_EXCLUSIVE', 'SAFT22kHz8BitStereo', 'DISPID_SVWaitUntilDone',
    'SPTEXTSELECTIONINFO', 'DISPID_SGRSTPropertyName',
    'DISPID_SWFESamplesPerSec', 'DISPID_SPRules_NewEnum'
]

_check_version('1.2.1', 1700170846.338360)
